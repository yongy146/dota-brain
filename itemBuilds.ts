 ...
 */
    ...
    export const itemBuilds = {
        ...
        "Axe": {
            ...
            early_game: [{item: "vanguard", isCore: true}, {item: "boots"}, {item: "magic_wand"}, {item: "cloak"}],
            mid_game: [{item: "blink", isCore: true}, {item: "manta", isCore: true}, {item: "aghanims_shard", isCore: true}, {item: "travel_boots"}, {item: "hood_of_defiance"}, {item: "blade_mail"}],
            late_game: [{item: "assault"}, {item: "abyssal_blade"}, {item: "moon_shard"}, {item: "overwhelming_blink", info: "Against illusion, clones and summons."}, {item: "swift_blink", info: "For single target burst."}],
            situational: [{item: "black_king_bar", info: "Against a lot of disables, magical damage and as a dispel."}, {item: "pipe"}, {item: "crimson_guard"}]
        },
        // 7. Pos 5
        "Bane": {
        ...
        // 9. Pos 3
        "Beastmaster": {
            starting: [{item: "tango"}, {item: "flask"}, {item: "quelling_blade"}, {item: "ring_of_protection"}, {item: "faerie_fire"}, {item: "enchanted_mango"}, {item: "circlet"}, {item: "gauntlets"}, {item: "branches"}, {item: "bracer"}, {item: "magic_stick", info: "If you expect high frequency of spells being used on the lane."}, {item: "orb_of_venom", info: "If you see yourself being able to hit the opponents on the lane often."}],
            early_game: [{item: "boots"}, {item: "phase_boots"}, {item: "medallion_of_courage"}, {item: "ring_of_basilius"}, {item: "magic_wand"}, {item: "orb_of_corrosion", info: "If you can pressure on the lane."}],
            mid_game: [{item: "solar_crest", isCore: true}, {item: "hood_of_defiance"}, {item: "helm_of_the_dominator"}, {item: "ultimate_scepter", info: "Particularly good against illusion based heroes."}, {item: "kaya", info: "Goes well with Aghanim's Scepter build."}, {item: "vladmir"}],
            late_game: [{item: "assault"}, {item: "kaya_and_sange", info: "Goes well with Aghanim's Scepter build."}, {item: "octarine_core", info: "Goes well with Aghanim's Scepter build."}],
            situational: [{item: "soul_ring", info: "If you are going for Wild Axes build."}, {item: "pipe"}, {item: "blink", info: "To reach backliners."}, {item: "black_king_bar", info: "Against a lot of disables, magical damage and as a dispel."}, {item: "aghanims_shard", info: "To improve vision game and gain another disable."}]
        },
        // 10. Pos 1, 3
        "Bloodseeker": {
            starting: [{item: "tango"}, {item: "quelling_blade"}, {item: "circlet"}, {item: "slippers"}, {item: "branches"}, {item: "faerie_fire"}, {item: "magic_stick", info: "If you expect high frequency of spells being used on the lane."}, {item: "orb_of_venom", info: "If you see yourself being able to hit the opponents on the lane often."}],
            ...
            mid_game: [{item: "maelstrom", isCore: true}, {item: "sange_and_yasha", isCore: true}, {item: "basher"}, {item: "skadi"}],
        ...
        "Brewmaster": {
            ...
            early_game: [{item: "boots"}, {item: "magic_wand"}, {item: "soul_ring"}, {item: "urn_of_shadows"}, {item: "power_treads"}, {item: "phase_boots"}],
        ...
        "Magnus": {
            ...
            early_game: [{item: "boots"}, {item: "power_treads", info: "If you are playing right-clicking Magnus.", isCore: true}, {item: "arcane_boots", info: "If you are playing utility Magnus.", isCore: true}, {item: "magic_wand"}, {item: "bracer"}, {item: "soul_ring"}, {item: "mask_of_madness", info: "If you are playing right-clicking Magnus."}],
        ...
        "Monkey King": {
            ...
            situational: [{item: "infused_raindrop", info: "On hero against magical burst."}, {item: "black_king_bar", info: "Against a lot of disables, magical damage and as a dispel."}, {item: "monkey_king_bar", info: "Against evasion."}, {item: "nullifier", info: "To dispel defensive spells and items."}, {item: "aeon_disk"}]
        },
        // 62. Pos 1, 2
        "Morphling": {
