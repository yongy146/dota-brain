...
export const counterItemsLaning = {
  ...
  Batrider: {
    ...
    support: [],
    core: [
      { item: "phase_boots", info: "Improves turn rate against Sticky Napalm" },
    ],
  },
  Beastmaster: {
    all: [
      ...
      { item: "blight_stone" },
      { item: "wind_lace", info: "To offset the slow coming from the boars" },
  ...
  "Bounty Hunter": {
    all: [
      ...
      { item: "armor", info: "Buy armor items against a core Bounty Hunter" },
    ],
  ...
  Bristleback: {
    all: [
      ...
      { item: "wind_lace", info: "To keep the distance from the Bristleback" },
  ...
  Broodmother: {
    all: [
      { item: "wind_lace", info: "To keep the distance from the Broodmother" },
    ...
    core: [
      { item: "ring_of_health" },
      { item: "vanguard", info: "To offset the damage coming from summons" },
    ],
  },
  "Centaur Warrunner": {
    all: [
  ...
  "Chaos Knight": {
    all: [
      { item: "wind_lace", info: "To keep the distance from the Chaos Knight" },
  ...
  Clockwerk: {
    all: [
      { item: "blight_stone" },
      { item: "wind_lace", info: "To keep the distance from the Clockwerk" },
  ...
  Dazzle: {
    all: [
      ...
      { item: "wind_lace", info: "To move away when Poison Touch is applied" },
  ...
  "Death Prophet": {
    all: [
      ...
      { item: "boots", info: "To keep the distance from the Death Prophet" },
      {
        item: "cloak",
  ...
  Enchantress: {
    ...
    support: [
      { item: "ward_sentry", info: "To block camps against Enchant ability" },
    ],
    core: [],
  },
  Enigma: {
  ...
  Invoker: {
    all: [
      ...
      { item: "boots", info: "To easier dodge some of his skill shot spells" },
      {
        item: "arcane_boots",
  ...
  Io: {
    all: [
      { item: "ring_of_regen", info: "To keep up with the sustain from Io" },
      {
        item: "wind_lace",
  ...
  Jakiro: {
    all: [
      { item: "magic_stick" },
      { item: "ring_of_regen", info: "One or two, for sustain on the lane" },
      {
        item: "headdress",
        info: "For lane sustain and/or Pipe of Insight later",
      },
  ...
  Juggernaut: {
    all: [
      { item: "wind_lace", info: "To keep the distance from the Juggernaut" },
  ...
  "Legion Commander": {
    all: [
      ...
      { item: "boots", info: "To keep the distance from the Legion Commander" },
      { item: "armor", info: "Buy armor items" },
    ],
    support: [],
    core: [
  ...
  Lifestealer: {
    all: [
      { item: "ring_of_regen", info: "For sustain on the lane" },
      { item: "wind_lace", info: "To keep the distance from the Lifestealer" },
  ...
  "Nyx Assassin": {
    all: [
      { item: "magic_stick" },
      { item: "arcane_boots", info: "To upkeep the mana against Mana Burn" },
      { item: "infused_raindrop" },
    ],
    support: [{ item: "ward_sentry" }, { item: "dust" }],
    core: [{ item: "soul_ring" }],
  ...
  Omniknight: {
    all: [
      ...
      { item: "boots", info: "To keep the distance from a core Omniknight" },
      {
        item: "urn_of_shadows",
  ...
  "Outworld Destroyer": /*"Outworld Devourer":*/ {
    all: [
      ...
      {
        item: "cloak",
        info: "Outworld Devourer's Astral Imprisonment and Sanity's Eclipse deal significant burst of magical damage",
      },
    ],
    support: [],
    core: [],
  ...
  "Spirit Breaker": {
    all: [
      { item: "wind_lace", info: "To keep the distance from Spirit Breaker" },
  ...
  "Void Spirit": {
    all: [
      ...
      { item: "ring_of_regen", info: "For sustain on the lane" },
      { item: "wind_lace", info: "To dodge Aether remnant and Dissimilate" },
  ...
  Windranger: {
    all: [
      { item: "magic_stick" },
      { item: "ring_of_regen", info: "One or two, for sustain on the lane" },
      { item: "wind_lace", info: "To keep the distance from the Windranger" },
  ...
  "Wraith King": {
    all: [
      { item: "blight_stone" },
      { item: "wind_lace", info: "To keep the distance from the Wraith King" },
