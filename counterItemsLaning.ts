 ...
 */
 ...
 export const counterItemsLaning = 
 {
     ...
     "Marci": {
         "all": [{"item": "magic_stick"}, {"item": "infused_raindrop"}, {"item": "wind_lace", "info": "To keep the distance from Marci"}, {"item": "boots", "info": "To keep the distance from Marci"}, {"item": "urn_of_shadows", "info": "To build Spirit Vessel against Marci's Sidekick"}, {"item": "ring_of_regen", "info": "For sustain on the lane"}, {"item": "blight_stone"}, {"item": "cloak", "info": "Marci is heavy on magical damage early on and Cloak will negate 15% of it"}, {"item": "armor", "info": "Buy armor items"}],
         "support": [],
         "core": [{"item": "ring_of_health"}, {"item": "vanguard"}, {"item": "orb_of_corrosion", "info": "If you are playing a melee core"}]
     },
     "Mars": {
