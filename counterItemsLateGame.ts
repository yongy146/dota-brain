export const counterItemsLateGame = {
  ...
  "Arc Warden": {
    ...
    core: [
      ...
      { item: "bloodthorn", info: "For true strike against Magnetic Field" },
      { item: "butterfly" },
      {
        item: "satanic",
  ...
  "Bounty Hunter": {
    ...
    core: [
      { item: "assault", info: "If it is a core right-clicking Bounty Hunter" },
  ...
  Broodmother: {
    ...
    support: [],
    core: [
      { item: "monkey_king_bar", info: "For true strike against Silken Bola" },
      { item: "abyssal_blade" },
  ...
  "Dark Seer": {
    ...
    core: [
      ...
      { item: "abyssal_blade" },
      { item: "shivas_guard", info: "To deal with Wall of Replica illusions" },
    ],
  },
  "Dark Willow": {
    all: [],
  ...
  "Elder Titan": {
    ...
    core: [
      { item: "assault" },
      { item: "butterfly", info: "Against a core right-clicking Elder Titan" },
    ],
  },
  "Ember Spirit": {
    all: [{ item: "sheepstick" }],
    support: [
      { item: "black_king_bar", info: "Against a magical build Ember Spirit" },
    ],
  ...
  Invoker: {
    all: [
      { item: "sheepstick" },
      { item: "aeon_disk" },
      { item: "wind_waker", info: "To save an ally from dying to Cataclysm" },
    ],
  ...
  Lifestealer: {
    ...
    core: [
      ...
      { item: "skadi", info: "To reduce healing from Feast and Open Wounds" },
      {
        item: "shivas_guard",
  ...
  Marci: {
    all: [
      ...
      { item: "aeon_disk" },
      { item: "ethereal_blade" },
      { item: "wind_waker", info: "To save an ally being focused by Marci" },
    ],
    support: [{ item: "black_king_bar" }],
    core: [
      { item: "abyssal_blade" },
      ...
      { item: "bloodthorn", info: "To burst this tanky hero" },
      { item: "skadi", info: "To reduce healing" },
      { item: "shivas_guard", info: "To reduce healing and for some armor" },
    ],
  },
  Medusa: {
    all: [{ item: "sheepstick" }, { item: "ethereal_blade" }],
  ...
  "Naga Siren": {
    ...
    core: [
      ...
      { item: "overwhelming_blink", info: "For AoE damage against illusions" },
      {
        item: "satanic",
  ...
  Necrophos: {
    all: [
      { item: "aeon_disk" },
      { item: "wind_waker", info: "To save an ally being Reaper's Scythed" },
    ],
    support: [{ item: "black_king_bar" }],
    core: [
      { item: "skadi" },
  ...
  Omniknight: {
    ...
    core: [
      { item: "skadi" },
      { item: "shivas_guard" },
      { item: "nullifier", info: "Dispels Heavenly Grace and Guardian Angel" },
      { item: "bloodthorn", info: "To burst this tanky hero" },
      {
        item: "mjollnir",
  ...
  "Shadow Fiend": {
    all: [
      { item: "sheepstick" },
      { item: "aeon_disk", info: "Against magical damage build" },
    ],
    support: [{ item: "black_king_bar" }],
    core: [
      { item: "assault" },
  ...
  Slark: {
    ...
    core: [
      { item: "abyssal_blade" },
      { item: "butterfly" },
      { item: "bloodthorn", info: "To burst him before he pops Shadow Dance" },
    ],
  },
  Snapfire: {
    all: [
      { item: "sheepstick", info: "Against a core right-clicking Snapfire" },
      {
        item: "ethereal_blade",
  ...
  Techies: {
    ...
    core: [
      { item: "heart", info: "To tank up and recover against Remote Mines" },
      {
        item: "satanic",
  ...
  Terrorblade: {
    all: [{ item: "sheepstick" }, { item: "ethereal_blade" }],
    support: [
      { item: "travel_boots", info: "To deal with splitpush by his illusions" },
    ],
    core: [
      {
        item: "mjollnir",
  ...
  Tinker: {
    ...
    core: [
      ...
      { item: "heart", info: "To tank up and recover against Tinker's spam" },
    ],
  },
  Tiny: {
    all: [
    ...
    core: [
      ...
      { item: "bloodthorn", info: "Against core Tiny to be able to burst him" },
    ],
  },
  "Treant Protector": {
    all: [],
  ...
  Viper: {
    ...
    support: [{ item: "black_king_bar" }],
    core: [
      { item: "abyssal_blade", info: "Against a core right-clicking Viper" },
