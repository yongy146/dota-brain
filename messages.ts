...
export const dotaCoachMessages: DotaCoachMessage[] = [
  ...
  },
  {
    ...
    textMessage:
      "Look to disrupt den's Freezing Field channeling in fights. She will try to protect herself with Glimmer Cape or BKB",
    chatMessage:
  ...
  },
  {
    category: "OwnHero",
    hero: "Earth Spirit",
    audioFile: "ownHero/EarthSpirit_6_SecureMid",
  ...
  },
  {
    category: "OwnHero",
    hero: "Morphling",
    audioFile: "ownHero/Morphling_10_EtherealBlade",
    messageTime: 18 * 60 + 30,
    textMessage:
  ...
  },
  {
    category: "EnemyHero",
    hero: "Nyx Assassin",
    audioFile: "enemyHero/NyxAssassin_6_ManaBurn",
    messageTime: 12 * 60,
    textMessage:
  ...
  },
  {
    category: "OwnHero",
    hero: "Ogre Magi",
    audioFile: "ownHero/OgreMagi_5_Squishy",
    messageTime: 15 * 60,
  ...
  },
  {
    ...
    messageTime: 19 * 60,
    textMessage:
      `Pick up Aghanims Scepter as the game progresses to amplify your damage output.`,
    audience: [Audience.ALL],
    image: { type: "item", name: "aghanims_shard" },
  },
