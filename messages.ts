...
export const ROLE_SUPPORT_HARD = 'HardSupport'
  ...
  export const dotaCoachMessages = [
    ...
    {category: "OwnHero", hero: "Abaddon", audioFile: "ownHero/Abaddon_8__Scepter", messageTime: 22*60, textMessage: "With Aghanim's Scepter, you will need to activate your Ultimate manually, after most of the damage has been inflicted on your teammates.", audience: [ROLE_OFFLANE, ROLE_SUPPORT]},
