...
export const dotaCoachMessages = [
    ...
    {category: "OwnHero", hero: "Sniper", audioFile: "ownHero/Sniper_5_TeamFight", messageTime: 10*60, repeatTime: 20*60, textMessage: "Don't let opponents see you at the start of a fight. Let them focus on someone else.", audience: [ALL]},
    {category: "OwnHero", hero: "Sniper", audioFile: "ownHero/Sniper_6_Shrapnel2", messageTime: 17*60, repeatTime: 20*60, textMessage: "If you feel you might be ganked, Shrapnel the wave and move out.", audience: [ALL]},
    {category: "OwnHero", hero: "Sniper", audioFile: "ownHero/Sniper_7_Shrapnel3", messageTime: 24*60, repeatTime: 20*60, textMessage: "Sniper is really strong at defending towers with Shrapnel and his long attack range.", audience: [ALL]},
    ...
    {category: "OwnHero", hero: "Storm Spirit", audioFile: "ownHero/Storm Spirit_3_Rush Orchid", messageTime: 5*60+30, textMessage: "If you have a solid start, get Orchid as soon as possible. It will allow you to pick-off most of the heroes on the map.", audience: [ALL]},
    {category: "OwnHero", hero: "Storm Spirit", audioFile: "ownHero/Storm Spirit_4_Ball Lightning 1", messageTimes: 6*60+45, textMessage: "You can right-click and use spells and items during Ball Lightning, including teleport.", audience: [ALL]},
    {category: "OwnHero", hero: "Storm Spirit", audioFile: "ownHero/Storm Spirit_5_Mana management", messageTimes: 8*60, repeatTime: 15*60, textMessage: "Mana management is the key. The more mana you have the more damage you can do. Be full mana if you expect fight to break out.", audience: [ALL]},
