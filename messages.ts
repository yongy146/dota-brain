...
export const ROLE_SUPPORT_HARD = 'HardSupport'
  ...
  export const dotaCoachMessages = [
    ...
    {category: "OwnHero", hero: "Abaddon", audioFile: "ownHero/Abaddon_8__Scepter", messageTime: 22*60, textMessage: "With Aghanim's Scepter, you ou will need to activate your Ultimate manually, after most of the damage has been inflicted on your teammates.", audience: [ROLE_OFFLANE, ROLE_SUPPORT]},
    ...
    {category: "OwnHero", hero: "Monkey King", audioFile: "ownHero/Monkey King_6_CuttingTrees", messageTime: 3*60+30, repreatTime: 20*60, textMessage: "Many spells and items can cut trees you are standing on, including those coming from your allies. Be careful about that.", audience: [ALL]},
