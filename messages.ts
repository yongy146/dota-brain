...
export const dotaCoachMessages = [
    ...
    {category: "OwnHero", hero: "Alchemist", audioFile: "ownHero/Alchemist_4_Dispel", messageTime: 6*60, textMessage: "Chemical Rage applies dispel on cast, same as Berserker's Potion. You can use them to dispel Spirit Vessel or other dispellable spells and items.", audience: [ALL]},
    ...
    {category: "OwnHero", hero: "Winter Wyvern", audioFile: "ownHero/Winter Wyvern_3_ColdEmbrace", messageTime: 90, textMessage: "Be careful when using Cold Embrace as a save. Often it is better to use your slows or Winter's Curse.", audience: [ALL]},
