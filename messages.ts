 ...
 */
 export function getMessages(hero): any[] {
  ...
  export const dotaCoachMessages = [
    ...
    {category: "EnemyHero", hero: "Legion Commander", audioFile: "heroes/Legion Commander_6_Aghanim's scepter", messageTimes: [(23*60+30), (33*60+30), (43*60+30)], textMessage: "Legion Commander takes 50% from other sources when duelling with Aghanim's Scepter", audience: "All"}
