...
export const heroBuilds: { [key: string]: HeroContent } = {
  ...
  Brewmaster: {
    ...
    item_tooltips: {
      ...
      hand_of_midas:
        `A core item that helps you maintain scaling in the game and get the necessary items to win the game.`,
  ...
  Clockwerk: {
    ...
    ability_tooltips: {
      ...
      special_bonus_unique_clockwerk_6:
        `You can take this talent over the suggested one if the opponents become short on damage once you become spell-immune.`,
    },
    item_tooltips: {
  ...
  "Dark Seer": {
    ...
    item_tooltips: {
      ...
      infused_raindrop: `Against magical burst.`,
      arcane_boots:
        `A core boots upgrade for mana sustain. You can disassemble it down the road or build into Guardian Greaves.`,
    ...
    builds: [
      {
        ...
        items: {
          starting: [`tango`, `blood_grenade`, `enchanted_mango`, `clarity`, `wind_lace`, `ward_observer`, `ward_sentry`],
          early_game: [
            `arcane_boots`,
            "magic_wand",
            `infused_raindrop`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          core: ["power_treads", "hand_of_midas",  "mjollnir", "manta", "black_king_bar", "aghanims_shard"],
          neutral: [
    ...
    builds: [
      {
        ...
        ability_tooltips: {
          gyrocopter_rocket_barrage:
            `You can put one more level in this spell during the laning phase if you have an aggressive laning partner with whom you can rack up kills.`,
    ...
    builds: [
      {
        ...
        items: {
          starting: [`tango`, `blood_grenade`, `ring_of_regen`, `faerie_fire`, `branches`, `branches`, `branches`, `ward_observer`, `ward_sentry`],
          early_game: [
            `headdress`,
			`magic_wand`,
            `mekansm`,
    ...
    builds: [
      {
        ...
        item_tooltips: {
          ...
          bottle:
            "If you have a bottle. You can do X Marks the spot refills.",
    ...
    counter_items: {
      ...
      mid_game: {
        all: [
		  ...
		  {	item: `cloak`, info: `Oracle does magical damage and Cloak offsets 20% of it` },
		],
  ...
  "Outworld Devourer": {
    ...
    builds: [
      ...
      },
      {
        ...
        items: {
          starting: [`tango`, `faerie_fire`, `mantle`, `circlet`, `branches`, `branches`, `ward_observer`],
          early_game: [
            `null_talisman`,
			`hand_of_midas`,
            `power_treads`,
    ...
    builds: [
      ...
      },
      {
        ...
        item_tooltips: {
          ...
          ultimate_scepter:
            `A core item that allows Sield Crash to cast Swashbuckle. Since you will have Maelstrom and Basher by this point, those will be procing as well.`,
        },
      },
    ],
    ability_tooltips: {},
  ...
  Razor: {
    ...
    item_tooltips: {
      ...
      refresher:
        `A late game pick up that allows you to have two Eye of the Storm, Static Link and Black King Bar in the fight among the other things it refreshes.`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: [`solar_crest`, `aghanims_shard`, `glimmer_cape`, `force_staff`],
          late_game: [
            `ultimate_scepter`,
            `refresher`,
            `octarine_core`,
