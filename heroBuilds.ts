...
export const heroBuilds: { [key: string]: HeroContent } = {
  ...
  "Arc Warden": {
    ...
    item_tooltips: {
      ...
      skadi:
        `A situational item that tanks you up and reduces targets movement speed and healing.`,
  ...
  Brewmaster: {
    ...
    builds: [
      {
        ...
        items: {
          ...
          core: [`soul_ring`, "boots", "ultimate_scepter", `wraith_pact`, `blink`, `black_king_bar`],
          neutral: [
            `occult_bracelet`,
            `lance_of_pursuit`,
			`bullwhip`,
    ...
    item_tooltips: {
      ...
      spirit_vessel: "Against heavy healing lineup.",
      ultimate_scepter:
        `A core item that gives you a brewling to fight as well as split push.`,
      blink:
      ...
      refresher:
        `A late game item that allows you to have 2 Primal Splits.`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          core: [`soul_ring`, `arcane_boots`, `orchid`, `black_king_bar`, `ultimate_scepter`, `assault`],
          neutral: [
            "arcane_ring",
            `lance_of_pursuit`,
            `bullwhip`,
  ...
  Chen: {
    ...
    ability_tooltips: {
		special_bonus_unique_chen_2:
			`You can take the strong dispel level 25 talent over this suggested one if they have strong AoE disables like Magnus RP or Tidehunter Ravage.`,
	},
    item_tooltips: {
  ...
  Clockwerk: {
    ...
    item_tooltips: {
      ...
      heavens_halberd: "Especially good against ranged right-clickers.",
      ultimate_scepter:
        `A core item that upgrades all your spells and improves your impact in fights.`,
      lotus_orb: "For reflect, dispel and armor.",
    },
    combo: [
  ...
  "Dark Seer": {
    ...
    item_tooltips: {
      ...
      ultimate_scepter:
        `A core item that lets you initiate in fights with a stun.`,
      blink:
        `Allows you to get Vacuum into Wall of Replica combo on multiple opponents. Goes well with Aghanims Scepter.`,
      aghanims_shard:
        `A luxury item in the late game.`,
  ...
  Kunkka: {
    ...
    builds: [
      {
        ...
        item_tooltips: {
          ...
          orchid:
            `Lets you snowball in the early game with your immense kill threat on the map.`,
          lesser_crit:
    ...
    item_tooltips: {
      ...
      armlet:
        `A situational item that provides you with early stats and damage for your Tidebringer.`,
      heavens_halberd:
    ...
    builds: [
      {
        ...
        items: {
          ...
          late_game: [`silver_edge`, `ultimate_scepter`, `heart`, `swift-blink`],
          situational: [
            `invis_sword`,
			`assault`,
            `overwhelming_blink`,
  ...
  "Night Stalker": {
    ...
    item_tooltips: {
      ...
      silver_edge:
        `Gives you pretty good stats and the ability to find backliners and scout. The break is also effective at removing passives.`,
    },
    combo: [
  ...
  Oracle: {
    ...
    item_tooltips: {
      ...
      infused_raindrop: "Against magical burst.",
      flask:
        `You can apply a Salve with False Promise as it doesnt get canceled.`,
      arcane_boots:
        "A core boots upgrade that helps with mana sustain. Can be disassembled and Energy Booster used for Holy Locket. Get Tranquil Boots afterwards.",
      tranquil_boots: `You can upgrade Brown Boots to Tranquils once you have the Aether Lens.`,
  ...
  "Outworld Devourer": {
    ...
    builds: [
      ...
      },
      {
        ...
        item_tooltips: {
          hand_of_midas:
            `A greedy pick up that lets you scale better into the late game.`,
          ...
          ultimate_scepter:
            `A luxury item that improves Astral Imprisonment and provides you with an extra charge of it.`,
          aghanims_shard:
    ...
    builds: [
      {
        ...
        item_tooltips: {
          ...
          aghanims_shard:
            `A luxury item in the late game when you are out of slots.`,
