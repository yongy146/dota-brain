    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: [`glimmer_cape`, `pavise`, `ultimate_scepter`],
          late_game: [`boots_of_bearing`, `force_staff`, `blink`, `refresher`],
          situational: [
            `ring_of_basilius`,
            `guardian_greaves`,
            `aether_lens`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: [`guardian_greaves`, `blink`, `aghanims_shard`, `pipe`],
          late_game: [
            `diffusal_blade`,
            `monkey_king_bar`,
            `ultimate_scepter`,
