...
export const heroBuilds: { [key: string]: HeroContent } = {
  ...
  "Bounty Hunter": {
    ...
    builds: [
      {
        ...
        items: {
          ...
          early_game: ["tranquil_boots", "magic_wand", `wind_lace`, `urn_of_shadows`],
          mid_game: [`force_staff`, `ultimate_scepter`],
          late_game: ["octarine_core", `lotus_orb`, "sheepstick", "boots_of_bearing"],
          situational: [
            `orb_of_venom`,
            `guardian_greaves`,
            "spirit_vessel",
    ...
    item_tooltips: {
      ...
      aghanims_shard: `A luxury late game pick up to improve mobility around the map for yourself and your team.`,
      ultimate_scepter:
    ...
    builds: [
      {
        ...
        items: {
          starting: [`tango`, `quelling_blade`, `mantle`, `circlet`, `branches`, `branches`],
          early_game: [`falcon_blade`, `power_treads`, `null_talisman`, "magic_wand", "maelstrom"],
          mid_game: [`black_king_bar`, `hurricane_pike`, `gungir`, `greater_crit`],
          late_game: [`ethereal_blade`, `revenants_brooch`, `skadi`, `swift_blink`],
          situational: [
            `witch_blade`,
            `blink`,
            "monkey_king_bar",
      ...
      },
      {
        ...
        items: {
          ...
          core: [`arcane_boots`, `guardian_greaves`, `blink`, `octarine_core`, `gungir`],
          neutral: [
            `arcane_ring`,
            `trusty_shovel`,
            `bullwhip`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          early_game: [`falcon_blade`, `power_treads`, `magic_wand`, "wraith_band", `wind_lace`],
      ...
      },
      {
        ...
        items: {
          ...
          early_game: [`boots`, `wraith_band`, `magic_wand`, `wind_lace`, `voodoo_mask`],
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: ["invis_sword", "ultimate_scepter", `lotus_orb`],
      ...
      },
      {
        ...
        items: {
          starting: ["tango", "quelling_blade", "gauntlets", `branches`, `branches`, `circlet`],
          early_game: ["phase_boots", "wind_lace", "magic_wand", "bracer", "soul_ring"],
          mid_game: ["invis_sword", "ultimate_scepter", `black_king_bar`, `yasha_and_kaya`],
          late_game: ["silver_edge", "assault", "moon_shard", "refresher"],
          situational: [
            "heavens_halberd",
            "pipe",
            "crimson_guard",
    ...
    builds: [
      ...
      },
      {
        ...
        items: {
          ...
          late_game: [`octarine_core`, `travel_boots`, `sheepstick`, "overwhelming_blink"],
          situational: [
            "cyclone",
            "black_king_bar",
            "aeon_disk",
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: ["spirit_vessel", "hood_of_defiance", `travel_boots`, "black_king_bar"],
          late_game: [
            "ultimate_scepter",
            "ethereal_blade",
            "shivas_guard",
      ...
      },
      {
        ...
        items: {
          ...
          mid_game: ["force_staff", `glimmer_cape`, `ultimate_scepter`],
          late_game: ["boots_of_bearing", "shivas_guard", "octarine_core", "sheepstick"],
          situational: [
            "veil_of_discord",
            "blink",
            "guardian_greaves",
  ...
  Viper: {
    ...
    builds: [
      ...
      },
      {
        ...
        items: {
          starting: ["tango", "faerie_fire", `branches`, `branches`, `circlet`, `ward_observer`],
          early_game: ["bottle", `boots`, "wind_lace", "magic_wand", "wraith_band"],
          mid_game: [`travel_boots`, `ultimate_scepter`, `bloodstone`, `eternal_shroud`],
          late_game: [`kaya_and_sange`, `black_king_bar`, `aghanims_shard`],
          situational: [
            `ring_of_basilius`,
            `spirit_vessel`,
            `blink`,
    ...
    ability_tooltips: {
      viper_nethertoxin: `At mid, consider putting a point in this spell at level 4 if the enemy midlaner has a passive you can break. You can also max out this spell in case you cannot fight the enemy mid with right clicks.`,
    },
    item_tooltips: {
      magic_wand: `Start with magic stick if you expect high frequency of spells being used on the lane.`,
      power_treads:
