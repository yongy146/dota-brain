    ...
    builds: [
      {
        ...
        items: {
          ...
          situational: ["magic_wand","orchid","cyclone", "sphere", "aeon_disk", "bloodthorn","arcane_blink" ],
          core: [
            "bottle",
            "null_talisman",
            "power_treads",
    ...
    builds: [
      {
        ...
        items: {
          ...
          situational: ["force_staff","glimmer_cape","ghost", "infused_raindrop", "cyclone", "blink", "aeon_disk"],
          core: [
            "soul_ring",
            "tranquil_boots",
            "veil_of_discord",
