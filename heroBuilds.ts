...
export const heroBuilds: { [key: string]: HeroBuilds } = {
    ...
    builds: [
      {
        ...
        items: {
          ...
          late_game: ["heart", "assault", "satanic", "skadi", "abyssal_blade", "overwhelming_blink"],
          situational: [
            "hand_of_midas",
            "blink",
            "black_king_bar",
        ...
        item_tooltips: {
          ...
          soul_ring:
            "Get this instead of bracers or with 1 bracer.",
          orchid_malevolence:
    ...
    builds: [
      {
        ...
        items: {
          ...
          late_game: ["greater_crit", "satanic", "bloodthorn", "scythe_of_vyse",],
          situational: [
            "infused_raindrop",
            "black_king_bar",
            "monkey_king_bar",
  ...
  "Dragon Knight": {
    ...
    item_tooltips: {
      ...
      hand_of_midas: 
        "If you can get it early usually on mid Dragon Knight.",
      blink:
