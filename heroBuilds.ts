...
export const heroBuilds: { [key: string]: HeroContent } = {
    ...
    builds: [
      ...
      },
      {
        ...
        items: {
          ...
          situational: [ "aghanims_shard", "mjollnir", "monkey_king_bar", "silver_edge", "nullifier"],
          core: [
            "bottle",
            "phase_boots",
            "bfury",
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: ["glimmer_cape", "aghanims_shard", "force_staff", `aether_lens`, `ghost`],
          ...
          core: ["arcane_boots", "wind_lace", `glimmer_cape`, "aghanims_shard", `aeon_disk`],
          neutral: [
            "trusty_shovel",
            "arcane_ring",
            `mysterious_hat`,
  ...
  "Anti-Mage": {
    ...
    item_tooltips: {
      magic_stick: "Start with it if you expect high frequency of spells being used on the lane.",
      orb_of_venom: "If you see yourself being able to hit and chase down the opponents on the lane often.",
    ...
    builds: [
      {
        ...
        items: {
          ...
          core: [`arcane_boots`, `aether_lens`, `tranquil_boots`, "glimmer_cape", "aghanims_shard", `force_staff`],
          neutral: [
            "trusty_shovel",
            `seeds_of_serenity`,
            "philosophers_stone",
  ...
  Enchantress: {
    ...
    ability_tooltips: {
      ...
      special_bonus_unique_enchantress_3: `You can take this talent over suggested one if the enemy team has 2-3 right click heroes.`,
    },
    item_tooltips: {
      ward_sentry: "To block or unblock the pull camp.",
      magic_wand: `Start with magic stick if you expect high frequency of spells on the lane. Replace one tango, sentry, and faerie fire each for it.`,
      infused_raindrop: "Against magical burst.",
      holy_locket: "A core item that adds to your healing output.",
      aghanims_shard: "A core item for additional healing. Fits well with Holy Locket.",
      lotus_orb: "For reflect, dispel and armor.",
    },
    ...
    builds: [
      {
        ...
        items: {
          ...
          early_game: ["arcane_boots", "magic_wand", `wind_lace`, `infused_raindrop`],
          mid_game: ["aether_lens", "aghanims_shard", "glimmer_cape", "force_staff"],
          late_game: [
            `blink`,
            "ultimate_scepter",
            "aeon_disk",
          ...
          situational: [`cyclone`, `guardian_greaves`, `wind_waker`, "lotus_orb", `travel_boots`],
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: ["sange","heavens_halberd", "black_king_bar", "ultimate_scepter", "aghanims_shard"],
    ...
    builds: [
      {
        ...
        items: {
          ...
          core: ["arcane_boots", "blink", "aether_lens", "aghanims_shard","force_staff", "refresher"],
          neutral: [
            "pogo_stick",
            "arcane_ring",
            "bullwhip",
    ...
    builds: [
      {
        ...
        items: {
          ...
          core: [`arcane_boots`, `aether_lens`, `tranquil_boots`, `blink`, `black_king_bar`, `aghanims_shard`],
          neutral: [
            `pogo_stick`,
            `trusty_shovel`,
            `occult_bracelet`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: ["holy_locket", "aghanims_shard", "cyclone", "meteor_hammer"],
          late_game: [
            "shivas_guard",
            "ultimate_scepter",
            "refresher",
          ...
          core: ["tranquil_boots", "holy_locket", "aghanims_shard", "shivas_guard"],
          neutral: [
            "trusty_shovel",
            "arcane_ring",
            "mysterious_hat",
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: ["blink", "black_king_bar", "aghanims_shard", "kaya_and_sange"],
          ...
          core: ["soul_ring", "phase_boots", "blink", "black_king_bar", "aghanims_shard"],
          neutral: [
            "chipped_vest",
            "arcane_ring",
            "vambrace",
      ...
      },
      {
        ...
        items: {
          ...
          late_game: ["wraith_pact", "arcane_blink", "refresher", "aeon_disk", "octarine_core"],
    ...
    builds: [
      {
        ...
        items: {
          ...
          core: ["bottle", "witch_blade", "travel_boots", "blink", "kaya", "ethereal_blade"],
          neutral: [
            "mysterious_hat",
            "arcane_ring",
            "grove_bow",
  ...
  Pugna: {
    ...
    builds: [
      ...
      },
      {
        ...
        items: {
          starting: ["tango", `flask`, `faerie_fire`, `enchanted_mango`, `circlet`, `branches`, `ward_observer`, `ward_sentry`],
          early_game: [
            "arcane_boots",
            "null_talisman",
            `magic_wand`,
          ...
          situational: [`force_staff`, `cyclone`, `ghost`, `lotus_orb`, `wind_waker`, `sphere`, `aghanims_shard`, `travel_boots`],
        ...
        item_tooltips: {
          ...
          wraith_pact:
            `A core item that makes your team more tanky with the damage reduction.`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          early_game: ["orb_of_corrosion", "power_treads", "magic_wand", "wraith_band"],
          mid_game: ["diffusal_blade", "manta", "aghanims_shard", "basher"],
          late_game: ["skadi", "ultimate_scepter", "greater_crit", "abyssal_blade", "butterfly"],
          situational: [
            "infused_raindrop",
            "bfury",
            "black_king_bar",
          ...
          core: ["orb_of_corrosion", "power_treads", "diffusal_blade", "manta", "basher"],
          neutral: [
            "unstable_wand",
            "possessed_mask",
            "vambrace",
      ...
      },
      {
        ...
        items: {
          starting: ["tango", "orb_of_venom", "flask", "branches", "branches", "faerie_fire"],
          ...
          core: ["meteor_hammer", "tranquil_boots", "aghanims_shard", "cyclone", "blink"],
          neutral: [
            "unstable_wand",
            "trusty_shovel",
            "philosophers_stone",
    ...
    builds: [
      {
        ...
        items: {
          ...
          core: ["soul_ring", "blink", "cyclone", "travel_boots", "aghanims_shard"],
          neutral: [
            "mysterious_hat",
            "arcane_ring",
            "vambrace",
    ...
    builds: [
      {
        ...
        items: {
          ...
          early_game: ["arcane_boots", "magic_wand", `wind_lace`, `infused_raindrop`],
          mid_game: ["aether_lens", `tranquil_boots`, "blink", "glimmer_cape", "force_staff"],
          late_game: [
            "ultimate_scepter",
            `aghanims_shard`,
            "aeon_disk",
    ...
    builds: [
      {
        ...
        items: {
          ...
          late_game: ["ultimate_scepter", "refresher", "aeon_disk", "sheepstick", `octarine_core`],
          situational: [
            "infused_raindrop",
            `arcane_boots`,
            `urn_of_shadows`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: [`arcane_boots`, "aether_lens", "blink", "force_staff", `ghost`],
          late_game: [
            "ultimate_scepter",
            "aeon_disk",
            `travel_boots`,
          ...
          core: [`rod_of_atos`, "aether_lens", `travel_boots`, "blink", "ultimate_scepter"],
          neutral: [],
        },
      },
    ],
