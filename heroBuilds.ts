...
export const standardAbilityBuildsOLD = {
  ...
  Clinkz: [
    ...
    "clinkz_wind_walk",
    "clinkz_searing_arrows",
  ] /* "clinkz_searing_arrows", "clinkz_burning_barrage", "clinkz_searing_arrows",  "clinkz_burning_barrage", "clinkz_burning_barrage",*/,
  Clockwerk: [
  ...
  Dawnbreaker: [
    ...
    "dawnbreaker_fire_wreath" /* equals to 'starbreaker' */,
    "dawnbreaker_celestial_hammer",
    "dawnbreaker_fire_wreath" /* equals to 'starbreaker' */,
    /* "dawnbreaker_luminosity", ,*/ "dawnbreaker_celestial_hammer",
  ],
  Dazzle: [
    "dazzle_poison_touch",
    "dazzle_shadow_wave",
  ...
  Grimstroke: [
    "grimstroke_dark_artistry" /* equals to 'stroke of faith' */,
    "grimstroke_spirit_walk" /* equals to 'ink swell' */,
    "grimstroke_spirit_walk" /* equals to 'ink swell' */,
    "grimstroke_ink_creature" /* equals to 'phantom's embrace' */,
    "grimstroke_spirit_walk" /* equals to 'ink swell' */,
  ],
  Gyrocopter: [
  ...
  "Keeper of the Light": [
    "keeper_of_the_light_illuminate" /*,  "keeper_of_the_light_radiant_bind" equals to 'solar bind' */,
  ...
  Luna: [
    ...
    "luna_lunar_blessing",
    "luna_lucent_beam",
    "luna_lunar_blessing" /* "luna_moon_glaive" equals to 'moon glaives' */,
  ],
  Lycan: [
    "lycan_summon_wolves",
    "lycan_feral_impulse",
  ...
  Necrophos: [
    ...
    "necrolyte_death_pulse",
    "necrolyte_sadist" /* equals to 'ghost shroud' */,
    "necrolyte_death_pulse",
  ],
  "Night Stalker": [
    "night_stalker_void",
  ...
  "Troll Warlord": [
    "troll_warlord_whirling_axes_ranged" /* needs to be either 'melee' or 'ranged' */,
