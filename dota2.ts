...
//    export function convertDotaCoachGuideRoleToDotaCoachRole(playerRole: PlayerRoles.DOTA_COACH_ROLE): PlayerRoles.DOTA_COACH_GUIDE_ROLE {
    export function convertDotaCoachRoleToDotaCoachGuidRole(playerRole: PlayerRoles.DOTA_COACH_ROLE): PlayerRoles.DOTA_COACH_GUIDE_ROLE {
            switch (playerRole) {
...
export namespace ability {
    ...
    export function getAbilities(heroName: string): string[] {
        DotaLogger.log("Dota2.hero.ability.getAbilities(heroName='" + heroName + "'): Called" )
        const heroNameNPC = hero.name.localizedNameToNPCName(heroName)
...
/*        for (var i=1; i<10; i++) {
    ...
    */
    export function getManaConsumption(heroAbility: string): string {
        DotaLogger.log("Dota2.ability.getManaConsumption(heroAbility='" + heroAbility + "'): Called" )
...
export namespace hero {
    ...
    export namespace attributes {
        ...
        function getAttributeColor(heroName: string, isTransparent: boolean): string {
            ...
            if (hero == null) {
                console.error("Dota2.hero.attributes.getAttributeColor(heroName: " + heroName + ", isTransparent: " + isTransparent + "): Hero not found.")
            } else {
                switch (hero.primary_attr) {
                    ...
                    default: {
                        console.error("Dota2.hero.attributes.getAttributeColor(heroName: " + heroName + ", isTransparent: " + isTransparent + "): Unknown primary attribute (" + hero.primary_attr + ")")
                        break
                    }
                }
            }
        ...
        export function getAttribute(heroName: string): string {
            ...
            if (hero==null) {
                DotaLogger.log(`dota2.getAttribute(heroName: ${heroName}): could not find hero's primary attribute.`)
                return null
            }
    ...
    export namespace build {
        ...
        export function getHeroBuild(heroName: string, playerRole: PlayerRoles.DOTA_COACH_ROLE): HeroBuilds.HeroBuild {
            ...
            var r: PlayerRoles.DOTA_COACH_GUIDE_ROLE = role.convertDotaCoachRoleToDotaCoachGuidRole(playerRole)
