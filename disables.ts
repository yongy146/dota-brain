...
export const channeling_interrupts = ["stun", "cyclone", "hex", "sleep", "mute", "fear", "taunt", "stop", "hide", "leash"]
...
{
	"Alchemist": [
		{skill: "alchemist_unstable_concoction", affects: "hero_area", disables: ["stun"]}
		// Unstable Concoction is cast on a hero but stuns and damages nearby heroes as well.
	],
	"Ancient Apparition": [
		{skill: "ancient_apparition_cold_feet", affects: "hero", disables: ["stun"]}
	...
	"Beastmaster": [
		{skill: "beastmaster_primal_roar", affects: "hero_area", disables: ["stun"]}
	...
	"Bounty Hunter": [
		{skill: "bounty_hunter_shuriken_toss", affects: "hero", disables: ["stun"]}
		// Can bounce off to other tracked heroes nearby.
	],
	"Brewmaster": [
		{skill: "brewmaster_earth_hurl_boulder", affects: "hero", disables: ["stun"]},
		{skill: "brewmaster_storm_cyclone", affects: "area", disables: ["cyclone"]}
	],
	"Bristleback": [],
	"Broodmother": [],
	"Centaur Warrunner": [
	...
	"Clinkz": [],
	"Clockwerk": [
		{skill: "rattletrap_battery_assault", affects: "area", disables: ["stun"]},
	...
	"Dark Willow": [
		...
		{skill: "dark_willow_cursed_crown", affects: "hero_area", disables: ["root"]},
    ...
    "Dawnbreaker": [
		...
		{skill: "dawnbreaker_solar_guardian", affects: "area", disables: ["stun"]}
	],
	"Dazzle": [],
	"Death Prophet": [
	...
	"Disruptor": [
		{skill: "disruptor_static_storm", affects: "area", disables: ["silence", "mute"]},
	...
	"Doom": [
		{skill: "doom_bringer_infernal_blade", affects: "hero", disables: ["stun"]},
		{skill: "doom_bringer_doom", affects: "hero", disables: ["silence", "mute"]}
	...
	"Drow Ranger": [
		{skill: "drow_ranger_wave_of_silence", affects: "area", disables: ["silence"]}
	],
	"Earth Spirit": [
		{skill: "earth_spirit_rolling_boulder", affects: "hero", disables: ["stun"]},
		// It can only stun one hero even if there are few heroes close to eachother.
		{skill: "earth_spirit_geomagnetic_grip", affects: "area", disables: ["silence"]}
	...
	"Elder Titan": [
		{skill: "elder_titan_earth_splitter", affects: "area", disables: ["stun"]},
		{skill: "elder_titan_echo_stomp", affects: "area", disables: ["sleep"]}
	],
	"Ember Spirit": [
		{skill: "ember_spirit_searing_chains", affects: "area", disables: ["root"]}
	],
	"Enchantress": [
	...
	"Faceless Void": [
		...
		{skill: "faceless_void_chronosphere", affects: "area", disables: ["stun"]}
	],
	"Grimstroke": [
	...
	"Jakiro": [
		{skill: "jakiro_ice_path", affects: "area", disables: ["stun"]}
	],
	"Io": [],
	"Juggernaut": [],
	"Keeper of the Light": [
		{skill: "keeper_of_the_light_will_o_wisp", affects: "area", disables: ["stun"]}
	...
	"Lone Druid": [
		...
		{skill: "lone_druid_entangling_claws", affects: "hero", disables: ["root"]}
	...
	"Meepo": [
		{skill: "meepo_earthbind", affects: "area", disables: ["root"]}
	],
	"Mirana": [
		{skill: "mirana_arrow", affects: "hero", disables: ["stun"]}
	],
	"Monkey King": [
		{skill: "monkey_king_boundless_strike", affects: "area", disables: ["stun"]}
	],
	"Morphling": [
		{skill: "morphling_adaptive_strike_str", affects: "hero", disables: ["stun"]}
	...
	"Naga Siren": [
		{skill: "naga_siren_song_of_the_siren", affects: "area", disables: ["sleep"]},
	...
	"Night Stalker": [
		...
		{skill: "night_stalker_crippling_fear", affects: "area", disables: ["silence"]}
	],
	"Nyx Assassin": [
		{skill: "nyx_assassin_impale", affects: "area", disables: ["stun"]},
		{skill: "nyx_assassin_spiked_carapace", affects: "hero", disables: ["stun"]}
...
//	"Outworld Devourer": [
	"Outworld Destroyer": [
			{skill: "obsidian_destroyer_astral_imprisonment", affects: "hero", disables: ["hide"]}
	...
	"Silencer": [
		...
		{skill: "silencer_global_silence", affects: "area", disables: ["silence"]}
	],
	"Skywrath Mage": [
		{skill: "skywrath_mage_ancient_seal", affects: "hero", disables: ["silence"]}
	...
	"Spectre": [],
	"Spirit Breaker": [
		{skill: "spirit_breaker_greater_bash", affects: "hero", disables: ["stun"]},
		{skill: "spirit_breaker_charge_of_darkness", affects: "area", disables: ["stun"]}
		// During Charge of Darkness Greater Bash is an area stun.
		// Nether Strike also stuns but only because it applies Greater Bash. 
	],
	"Storm Spirit": [
		{skill: "storm_spirit_electric_vortex", affects: "hero", disables: ["stun"]}
	...
	"Troll Warlord": [
		{skill: "troll_warlord_berserkers_rage", affects: "hero", disables: ["root"]}
	],
	"Tusk": [
	...
	"Underlord": [
		{skill: "abyssal_underlord_pit_of_malice", affects: "area", disables: ["root"]}
	],
	"Undying": [],
	"Ursa": [],
	"Vengeful Spirit": [
		{skill: "vengefulspirit_magic_missile", affects: "hero", disables: ["stun"]},
		{skill: "vengefulspirit_nether_swap", affects: "hero", disables: ["stun"]}
	],
	"Venomancer": [],
	"Viper": [
	...
	"Void Spirit": [
		{skill: "void_spirit_aether_remnant", affects: "hero", disables: ["stun"]}
	...
	"Winter Wyvern": [
		{skill: "winter_wyvern_cold_embrace", affects: "hero", disables: ["stun"]},
		{skill: "winter_wyvern_winters_curse", affects: "hero_area", disables: ["stun"]}
	...
	"Witch Doctor": [
		{skill: "witch_doctor_paralyzing_cask", affects: "hero_area", disables: ["stun"]}
		// Can also be seen as an area stun.
	],
	"Wraith King": [
		{skill: "skeleton_king_hellfire_blast", affects: "hero", disables: ["stun"]}
